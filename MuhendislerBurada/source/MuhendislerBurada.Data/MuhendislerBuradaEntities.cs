...
using MuhendislerBurada.Data.Configuration;
using System.Reflection;

namespace MuhendislerBurada.Data.Models
{
    public class MuhendislerBuradaEntities : IdentityDbContext<ApplicationUser>
    {

        public MuhendislerBuradaEntities()
            : base("MuhendislerBuradaEntities")
        {
        }
