...
namespace MuhendislerBurada.Web.Services
{
        ...
        private string DateCalculation(DateTime  CreatedDate)
        {
            ...
            if (creDate == dateNow)
            {
                ...
                if (duration.Hours >= 1)
                {
                    ...
                    return notificationdate = duration.Hours.ToString() + " " + "saat önce";

                }
                else if (duration.Minutes >= 1)
                {

                        return notificationdate = duration.Minutes.ToString() + " " + "dakika önce";

                }
                else
                {
                    return notificationdate = "birkaç saniye önce ";
                }
            }
            else
            {
                ...
                else
                {
                        ...
                        return notificationdate = duration.Days.ToString() + " " + "gün önce";
                }
            }
