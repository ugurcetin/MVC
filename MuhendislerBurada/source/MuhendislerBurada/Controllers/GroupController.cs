...
namespace MuhendislerBurada.Web.Controllers
{
    ...
    public class GroupController : Controller
    {
        ...
        public ViewResult Index(int id)
        {
            ...
            //group.GroupUserId = groupUserService.GetGroupUserByuserId(((MuhendislerBuradaUser)(User.Identity)).UserId).GroupUserId;
            group.Users = groupUserService.GetMembersOfGroup(id);
            //if (group.GroupUser.UserId == ((MuhendislerBuradaUser)(User.Identity)).UserId)
        ...
        public ActionResult CreateGroup(GroupFormModel newGroup)
        {
            ...
            {
                //group.UserId = ((MuhendislerBuradaUser)(User.Identity)).UserId;
                var createdGroup = groupService.CreateGroup(group, userId);
                //var createdGroup = groupService.GetGroup(newGroup.GroupName);
                //var groupAdmin = new GroupUser { GroupId = createdGroup.GroupId, UserId = ((MuhendislerBuradaUser)(User.Identity)).UserId, Admin = true };
        ...
        public ActionResult CreateGoal(GroupGoalFormModel goal)
        {
            ...
            if (ModelState.IsValid)
            {
                //groupgoal.GroupUser.UserId = ((MuhendislerBuradaUser)(User.Identity)).UserId;
