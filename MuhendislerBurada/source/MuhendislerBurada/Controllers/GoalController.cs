    ...
    public class GoalController : Controller
    {
        ...
        public PartialViewResult DisplayUpdates(int id)
        {
            ...
            UpdateListViewModel updates = new UpdateListViewModel()
            {
                ...
                // IsSupported =  updateSupportService.IsUpdateSupported(,((MuhendislerBuradaUser)(User.Identity)).UserId)
            };
                ...
                else
                {
                    updateService.CreateUpdate(update);
                     ...
                     UpdateListViewModel updates = new UpdateListViewModel()
                     {
                         ...
                         //IsSupported = updateSupportService.IsUpdateSupported(newupdate.UpdateId,((MuhendislerBuradaUser)(User.Identity)).UserId)
                     };
                     return PartialView("_UpdateView", updates);
